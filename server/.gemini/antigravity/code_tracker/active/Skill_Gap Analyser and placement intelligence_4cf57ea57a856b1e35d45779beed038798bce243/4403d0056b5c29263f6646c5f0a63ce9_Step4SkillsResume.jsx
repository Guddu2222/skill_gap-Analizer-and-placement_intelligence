ÎNimport React, { useState } from 'react';
      ...
      <div className="max-w-3xl w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            {/* Resume Upload - Simplified for now as a URL */}
            <div className="pt-4 border-t">
              <label className="block text-sm font-bold text-gray-900 mb-2 flex items-center gap-2">
                <Upload className="w-5 h-5 text-indigo-600" />
                Resume Link <span className="text-gray-400 font-normal">(Optional)</span>
              </label>
              <input
                type="url"
                value={formData.resumeUrl || ''}
                onChange={(e) => updateFormData({ resumeUrl: e.target.value })}
                placeholder="Google Drive, Dropbox, or hosted PDF link"
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
              />
              <p className="mt-1 text-xs text-gray-500">Ensure link is public / anyone with link can view.</p>
            </div>
...
»2 *cascade08»2ø2*cascade08ø2ÎN *cascade08"(4cf57ea57a856b1e35d45779beed038798bce2432ƒfile:///d:/project/Skill_Gap%20Analyser%20and%20placement%20intelligence/client/src/pages/signup/signup-steps/Step4SkillsResume.jsx:Hfile:///d:/project/Skill_Gap%20Analyser%20and%20placement%20intelligence