    ...
    <div className="bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100">
      ...
      <div className="grid grid-cols-3 gap-2 mb-4 text-center">
        <div className="bg-blue-50 rounded-lg py-2">
          <p className="font-bold text-gray-900">{expert.cgpa ?? 'â€“'}</p>
        ...
        <div className="bg-green-50 rounded-lg py-2">
          <p className="font-bold text-gray-900">{expert.graduationYear ?? 'â€“'}</p>
...
‘3*cascade08"(4cf57ea57a856b1e35d45779beed038798bce2432zfile:///d:/project/Skill_Gap%20Analyser%20and%20placement%20intelligence/client/src/components/recruiter/DomainExperts.jsx:Hfile:///d:/project/Skill_Gap%20Analyser%20and%20placement%20intelligence