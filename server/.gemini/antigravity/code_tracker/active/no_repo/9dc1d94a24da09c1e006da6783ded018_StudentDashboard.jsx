ÏŒimport React, { useState, useEffect } from 'react';
        ...
        <div className="relative overflow-hidden bg-gradient-to-r from-blue-900 via-indigo-900 to-purple-900 rounded-3xl shadow-xl mb-8 border border-white/20">
          ...
          <div className="relative z-10 p-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div className="flex items-center gap-6">
              <div className="w-24 h-24 rounded-2xl bg-white/10 backdrop-blur-md flex items-center justify-center text-4xl font-bold text-white shadow-inner border border-white/20">
                {student.firstName ? student.firstName[0] : student.user?.name[0]}
              </div>
              <div>
...
Èˆ*cascade08Èˆáˆ *cascade08áˆãˆ*cascade08ãˆ’‰ *cascade08’‰’Œ*cascade08’ŒÏŒ *cascade082nfile:///d:/project/Skill_Gap%20Analyser%20and%20placement%20intelligence/client/src/pages/StudentDashboard.jsx