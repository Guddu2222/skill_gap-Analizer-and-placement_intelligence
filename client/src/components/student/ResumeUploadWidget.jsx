      ...
      <div className="flex justify-between items-start mb-4 relative z-10">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">
            Required to apply for placements and boost your profile visibility.
          </p>
        </div>
      </div>
        ...
        <div className="relative z-10">
          {!file ? (
            ...
            >
              ...
              >
                <div
                  className={`w-14 h-14 rounded-full flex items-center justify-center mb-4 shadow-sm transition-colors ${isDragActive ? "bg-indigo-100 text-indigo-600" : "bg-white text-slate-400 border border-slate-100"}`}
                >
              ...
              <div className="flex items-center justify-between bg-white border border-slate-200 rounded-xl p-4 shadow-sm mb-4">
                <div className="flex items-center gap-4 overflow-hidden">
                  ...
                  <div className="overflow-hidden">
                    <h4 className="font-semibold text-slate-800 text-sm truncate w-48 md:w-64">
                      {file.name}
                    </h4>
