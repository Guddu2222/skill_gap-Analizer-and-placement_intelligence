  ...
  return (
    <Router>
      <Routes>
        ...
        <Route
          path="/student"
          element={<StudentDashboard activeRoute="overview" />}
        />
        <Route
        ...
        <Route
          path="/student/paths"
          element={<StudentDashboard activeRoute="learning" />}
        />
        <Route
          path="/student/skills"
          element={<StudentDashboard activeRoute="skills" />}
        />
        <Route
        ...
        <Route
          ...
          element={<StudentDashboard activeRoute="opportunities" />}
        />
        <Route
          path="/student/mentorship"
          element={<StudentDashboard activeRoute="mentorship" />}
        />
        <Route
