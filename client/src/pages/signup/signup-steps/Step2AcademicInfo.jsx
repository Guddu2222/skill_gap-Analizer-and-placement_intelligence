      ...
      <div className="max-w-3xl w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* College Internal Roll Number */}
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">
                College Internal Roll Number
                <span className="ml-2 text-xs font-normal text-blue-600 bg-blue-50 px-2 py-0.5 rounded-full">Optional</span>
              </label>
              <div className="relative">
                <Hash className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" />
                <input
                  ...
                  onChange={(e) => updateFormData({ collegeRollNumber: e.target.value })}
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  placeholder="e.g., CS-2023-047 (assigned by your college)"
                />
              </div>
              <p className="mt-1 text-xs text-gray-500">
                Different from the university roll number above. This helps your placement officer find you easily.
              </p>
            </div>
