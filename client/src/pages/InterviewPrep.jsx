      ...
      <main className="flex-1 ml-64 p-8">
        <header className="mb-8 flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-500">
              Real interview experiences from students & alumni.
            </p>
          </div>
        ...
        <div className="space-y-4">
          {interviews.map((item) => (
            <div
              key={item.id}
              className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:border-blue-200 transition cursor-pointer group"
            >
              ...
              <div className="pl-16">
                <p className="text-gray-600 text-sm line-clamp-2">
                  "The online assessment had 2 dynamic programming questions.
                  The technical interview focused heavily on HashMaps and Trees.
                  System design round was about designing a URL shortener..."
                </p>
                <div className="mt-4 flex gap-2">
                  {["DSA", "System Design", "Behavioral"].map((tag, i) => (
                    <span
                      key={i}
                      className="px-2 py-1 bg-gray-100 text-gray-500 text-xs rounded border border-gray-200"
                    >
                      {tag}
                    </span>
                  ))}
