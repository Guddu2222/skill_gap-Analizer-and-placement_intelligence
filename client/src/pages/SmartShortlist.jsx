      ...
      <main className="flex-1 ml-64 p-8">
        <header className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900">
            Smart Shortlisting & Scheduling
          </h1>
          <p className="text-gray-500">
            AI-powered candidate matching and logistics automation.
          </p>
        </header>
        ...
        <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm mb-8 flex gap-4 items-center">
          <div className="flex-1 flex gap-2">
            ...
            <span className="px-3 py-1 bg-gray-50 text-gray-600 rounded-lg text-sm border border-gray-200">
              CGPA &gt; 8.0
            </span>
          </div>
          <button
              ...
              >
                  ...
                  <div>
                    ...
                    <div className="flex gap-2 text-xs text-gray-500 mt-1">
                      {c.skills.map((s, i) => (
                        <span
                          key={i}
                          className="bg-gray-50 px-1.5 py-0.5 rounded border border-gray-200"
                        >
                          {s}
                        </span>
                      ))}
                ...
                <div className="text-right">
                  <div className="flex items-center justify-end gap-2 mb-1">
                    <span
                      className={`text-lg font-bold ${c.prediction > 80 ? "text-green-600" : "text-amber-500"}`}
                    >
                      {c.prediction}%
                    </span>
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm h-fit">
            ...
            {schedule.length === 0 ? (
              <div className="text-center py-8 text-gray-400 text-sm">
                ...
                <br />
                Click "Auto-Schedule" to generate.
              </div>
            ) : (
                ...
                {schedule.map((s, i) => (
                  <div key={i} className="relative flex items-start gap-4">
                    ...
                    <div className="flex-1 bg-indigo-50 p-3 rounded-lg border border-indigo-100">
                      ...
                      <a
                        href="#"
                        className="text-xs text-indigo-500 hover:text-indigo-700 underline mt-2 block"
                      >
                        View Meeting Link
                      </a>
                    </div>
