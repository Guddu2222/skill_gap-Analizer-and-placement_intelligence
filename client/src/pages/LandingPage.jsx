        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-600">
              Seamlessly connecting every stakeholder in the recruitment
              lifecycle with purpose-built tools.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="group p-6 rounded-2xl border border-gray-100 hover:border-blue-100 hover:shadow-xl hover:shadow-blue-50 transition-all bg-white relative overflow-hidden">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Build your AI-verified profile, bridge skill gaps, and get
                matched with your dream companies.
              </p>
              <Link
                to="/signup/student"
            ...
            <div className="group p-6 rounded-2xl border border-gray-100 hover:border-blue-100 hover:shadow-xl hover:shadow-blue-50 transition-all bg-white relative overflow-hidden">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Digitize placement cells, track student progress in real-time,
                and improve corporate relations.
              </p>
              <Link
                to="/signup/college"
                className="inline-flex items-center text-blue-600 font-semibold text-sm group-hover:gap-2 transition-all"
            ...
            <div className="group p-6 rounded-2xl border border-gray-100 hover:border-blue-100 hover:shadow-xl hover:shadow-blue-50 transition-all bg-white relative overflow-hidden">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Access a pre-screened talent pool, conduct AI-proctored
                assessments, and hire 10x faster.
              </p>
              <Link
                to="/signup/recruiter"
                className="inline-flex items-center text-blue-600 font-semibold text-sm group-hover:gap-2 transition-all"
